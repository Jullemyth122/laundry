                ...
                <div className="book-section">
                    ...
                    <form className="flex items-center justify-around flex-wrap books-form">
                        ...
                        <div className="flex inputs-flex-form">
                            ...
                            <div className="input-item"><input type="text" placeholder='Items Count' /></div>
                        </div>
                        <div className="flex inputs-flex-form">
                            <div className="input-item"><input type="text" placeholder='Service ||| Cleaning' /></div>
